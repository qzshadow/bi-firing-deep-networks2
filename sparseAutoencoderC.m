function [cost,grad] = sparseAutoencoderC(theta, info, visibleSize, hiddenSize1,hiddenSize2, ...
...
[grad info] = param2stack(W1grad,W2grad,W3grad,W4grad,b1grad,b2grad,b3grad,b4grad);
